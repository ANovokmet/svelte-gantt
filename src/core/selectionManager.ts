...
export class SelectionManager {
    ...
    constructor(
        private taskStore: EntityStore<SvelteTask>
    ) {
    }
    ...
    toggleSelection(taskId, node) {
        this.currentSelection.set(taskId, { HTMLElement: node, offsetData: undefined, draggable: undefined });
        this.selectedTasks.update(selections => ({ ...selections, [taskId]: !selections[taskId] }));
    }
