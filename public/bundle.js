var app = (function () {
	...
	assign(Arrow.prototype, methods$3);
	...
	assign(Dependency.prototype, methods$4);
	...
	function create_main_fragment$8(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div_3, file$8, 7, 8, 247);
				div_2.className = "main-header-container svelte-95ghe2";
				addLoc(div_2, file$8, 6, 4, 154);
	...
	function Grid(options) {
		...
		init(this, options);
		this.refs = {};
		this._state = assign(assign(this.store._init(["rowHeight","width","headers","height"]), data$5()), options.data);
	...
	assign(Grid.prototype, methods$5);
