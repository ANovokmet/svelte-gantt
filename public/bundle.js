var app = (function () {
	...
	function create_main_fragment$5(component, ctx) {
		var div, div_1, text, div_2, text_2, div_3, scrollListener_action, text_4, div_4, div_5, div_6, text_6, div_7, scrollable_action, current;
		...
		return {
			c: function create() {
				...
				addLoc(div_7, file$5, 26, 12, 860);
				div_5.className = "content svelte-m71b7o";
				addLoc(div_5, file$5, 20, 8, 637);
				div_4.className = "main-container svelte-m71b7o";
				setStyle(div_4, "height", "" + ctx.$height + "px");
				setStyle(div_4, "width", "" + ctx.$width + "px");
				scrollable_action = scrollable.call(component, div_4) || {};
				addLoc(div_4, file$5, 19, 4, 540);
				div.className = "grid svelte-m71b7o";
	...
	function Grid(options) {
		...
		init(this, options);
		this.refs = {};
		this._state = assign(assign(this.store._init(["headerHeight","width","headers","height"]), data$2()), options.data);
