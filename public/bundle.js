var app = (function () {
	...
	function create_main_fragment$7(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div_10, file$7, 40, 12, 1580);
	...
	// (34:16) {#each visibleRows as row (row.id)}
	...
	// (42:16) {#each visibleDependencies as dependency (dependency.id)}
	...
	for(let i = 0; i < 4999; i++){
		data$5.dependencies.push({id: i, fromTask: data$5.rows[i].tasks[0], toTask: data$5.rows[i+1].tasks[0] });
	}
