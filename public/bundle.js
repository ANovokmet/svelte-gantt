var app = (function () {
	...
	function create_main_fragment$7(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div_9, file$7, 40, 12, 1522);
			...
			o: function outro(outrocallback) {
				...
				for (let i = 0; i < each_3_blocks.length; i += 1) outroBlock_2(i, 0, countdown_3);

				const countdown_4 = callAfter(outrocallback, each_4_blocks.length);
				for (let i = 0; i < each_4_blocks.length; i += 1) outroBlock_3(i, 0, countdown_4);
	...
	function Grid(options) {
		...
		init(this, options);
		this.refs = {};
		this._state = assign(assign(this.store._init(["rowHeight","headerHeight","width","headers","height"]), data$4()), options.data);
	...
	var app = Grid.create(document.body, data$5, options);
