var SvelteGantt = (function () {
	    ...
	    SvelteGantt.create = function(target, data, options) {
	        ...
	        for(let i=0; i < data.rows.length; i++){
	            ...
	            for(let j=0; j < row.tasks.length; j++){
	                ...
	                row.tasks[j] = new SvelteTask$1(task, ganttUtils);
	...
	function Grid(options) {
		...
		init(this, options);
		this.refs = {};
		this._state = assign(assign(this.store._init(["rowHeight","width","headers","height"]), data$7()), options.data);
		this.store._add(this, ["rowHeight","width","headers","height"]);
