var app = (function () {
	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				div.className = "row svelte-1u02r8a";
	...
	const file$5 = "src\\Grid.html";

	function create_main_fragment$5(component, ctx) {
		var div, div_1, text, div_2, text_2, div_3, text_4, div_4, div_5, text_6, div_6, current;
		...
		return {
			c: function create() {
				...
				div_1.className = "side-header-container svelte-tw3ejv";
				setStyle(div_1, "height", "" + ctx.$headerHeight + "px");
				setStyle(div_1, "width", "100px");
				addLoc(div_1, file$5, 2, 4, 26);
				div_2.className = "main-header-container svelte-tw3ejv";
				setStyle(div_2, "height", "" + ctx.$headerHeight + "px");
				setStyle(div_2, "width", "" + ctx.$width + "px");
				addLoc(div_2, file$5, 6, 4, 132);
				div_3.className = "side-container svelte-tw3ejv";
				addLoc(div_3, file$5, 12, 4, 335);
				div_5.className = "column-container svelte-tw3ejv";
				addLoc(div_5, file$5, 20, 8, 557);
				div_6.className = "row-container svelte-tw3ejv";
				addLoc(div_6, file$5, 25, 8, 725);
				div_4.className = "main-container svelte-tw3ejv";
				setStyle(div_4, "width", "" + ctx.$width + "px");
				addLoc(div_4, file$5, 19, 4, 494);
				div.className = "grid svelte-tw3ejv";
			...
			p: function update(changed, ctx) {
				...
				if (changed.$rows || changed.width) {
					each_value_3 = ctx.$rows;
	...
	function create_each_block_3(component, ctx) {
		...
		return {
			...
			p: function update(changed, _ctx) {
				...
				if (!row_updating.tasks && changed.$rows) {
	...
	function Grid(options) {
		...
		init(this, options);
		this.refs = {};
		this._state = assign(assign(this.store._init(["headerHeight","width","headers","rows"]), data$2()), options.data);
		this.store._add(this, ["headerHeight","width","headers","rows"]);
	...
	function create_main_fragment$6(component, ctx) {
		...
		return {
			...
			p: function update(changed, _ctx) {
				ctx = _ctx;
				var grid_changes = {};
				if (changed.from) grid_changes.from = ctx.from;
				if (changed.to) grid_changes.to = ctx.to;
				if (changed.width) grid_changes.width = ctx.width;
				if (!grid_updating.rows && changed.rows) {
	...
	function App(options) {
		...
		if (!('from' in this._state)) console.warn("<App> was created without expected data property 'from'");
		if (!('to' in this._state)) console.warn("<App> was created without expected data property 'to'");
		if (!('width' in this._state)) console.warn("<App> was created without expected data property 'width'");
		this._intro = !!options.intro;
