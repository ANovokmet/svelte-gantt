var SvelteGanttDependencies = (function () {
	...
	/* src\modules\dependencies\Arrow.html generated by Svelte v2.16.0 */
	...
	function create_main_fragment(component, ctx) {
		...
		return {
			c: function create() {
				...
				addListener(path0, "click", click_handler);
				setAttribute(path0, "d", ctx.path);
				setAttribute(path0, "stroke", "red");
				setAttribute(path0, "fill", "transparent");
				setAttribute(path0, "class", "select-area svelte-m8v62h");
				addLoc(path0, file, 1, 2, 114);
				setAttribute(path1, "d", ctx.arrowPath);
				setAttribute(path1, "fill", "red");
				addLoc(path1, file, 3, 2, 210);
			...
			d: function destroy$$1(detach) {
				...
				removeListener(path0, "click", click_handler);
			}
		};
	}
	...
	/* src\modules\dependencies\Dependency.html generated by Svelte v2.16.0 */
	...
	/* src\modules\dependencies\GanttDependencies.html generated by Svelte v2.16.0 */
