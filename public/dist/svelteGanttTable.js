var SvelteGanttTable = (function () {
	...
	function height({$height, $parentWidth, $width}) {
		return $width > $parentWidth ? $height - H_SCROLLBAR_WIDTH : $height;
	}
	...
	var methods = {
	    ...
	    onGanttCreated() {
	        ...
	        this.root.api.gantt.on.viewChanged(updateHeight);
	        updateHeight();
	    }
	};
	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				div0.className = "table-header-container svelte-w66tk";
				setStyle(div0, "width", "" + ctx.scrollWidth + "px");
				addLoc(div0, file$1, 1, 4, 66);
				div1.className = "table-row-container svelte-w66tk";
				...
				div2.className = "table-scroll-container svelte-w66tk";
				setStyle(div2, "height", "" + ctx.height + "px");
				addLoc(div2, file$1, 9, 4, 360);
				div3.className = "table-container svelte-w66tk";
	...
	function create_each_block_1(component, ctx) {
		...
		return {
			c: function create() {
				...
				div.className = "row-header-cell svelte-w66tk";
				setStyle(div, "width", "" + ctx.header.width + "px");
