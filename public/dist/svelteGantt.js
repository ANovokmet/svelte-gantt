var SvelteGantt = (function () {
	...
	function visibleTasks({visibleRows}) {
	    const visibleTasks = [];
	...
	// (45:12) {#each _ganttBodyModules as module (module.key)}
	...
	function Gantt(options) {
		...
		init(this, options);
		this.refs = {};
		this._state = assign(assign(this.store._init(["rows","rowHeight","classes","headerWidth","width","headers","_timeRanges","height"]), data$5()), options.data);
		this.store._add(this, ["rows","rowHeight","classes","headerWidth","width","headers","_timeRanges","height"]);

		this._recompute({ $rows: 1, $rowHeight: 1, scrollTop: 1, startIndex: 1, viewportHeight: 1, endIndex: 1, visibleRows: 1 }, this._state);
