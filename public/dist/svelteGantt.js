var SvelteGantt = (function () {
	...
	function Gantt(options) {
		...
		init(this, options);
		this.refs = {};
		this._state = assign(assign(this.store._init(["rowHeight","classes","headerWidth","width","headers","_timeRanges","height"]), data$5()), options.data);
		this.store._add(this, ["rowHeight","classes","headerWidth","width","headers","_timeRanges","height"]);
