var SvelteGantt = (function () {
	...
	function create_main_fragment$6(component, ctx) {
		...
		function div8_resize_handler() {
			component.store.set({ cw: div8.clientWidth });
		}
	...
	function Gantt(options) {
		...
		init(this, options);
		this.refs = {};
		this._state = assign(assign(this.store._init(["from","to","width","columnOffset","columnUnit","rows","rowHeight","taskMap","classes","headerWidth","headers","_timeRanges","height","cw"]), data$5()), options.data);
		this.store._add(this, ["from","to","width","columnOffset","columnUnit","rows","rowHeight","taskMap","classes","headerWidth","headers","_timeRanges","height","cw"]);
		...
		if (!('$cw' in this._state)) console.warn("<Gantt> was created without expected data property '$cw'");
